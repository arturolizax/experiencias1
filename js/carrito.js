...
function comprarCarrito() {
    ...
    if(!usuario){
        Toastify({
            text: "Debes iniciar sesión para poder realizar una compra",
            duration: 3000,
            close: true,
            gravity: "top",
            position: "right",
            stopOnFocus: true,
            style: {
                background: "linear-gradient(to right,rgb(168, 51, 133),rgb(163, 10, 18))",
                borderRadius: "2rem",
                textTransform: "uppercase",
                fontSize: ".75rem"
            },
...
loginContainer.addEventListener("click", goToLoginPage);
